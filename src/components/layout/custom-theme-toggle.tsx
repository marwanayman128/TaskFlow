...
const Stars = () => (
  <svg fill="none" viewBox="0 0 144 55" xmlns="http://www.w3.org/2000/svg" aria-hidden>
    <path
      fill="currentColor"
...
export function CustomThemeToggle() {
  ...
  if (!mounted) {
    return (
      <label className="theme-switch" aria-live="polite">
        <input className="theme-switch__checkbox" type="checkbox" checked={false} disabled />
        {SwitchBody}
      </label>
    );
  }
